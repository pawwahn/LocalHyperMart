    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/catalog/categories/*/town-visibility").authenticated()
                        ...
                        .requestMatchers(HttpMethod.PATCH, "/api/v1/catalog/categories/visibility").authenticated()
                        .requestMatchers(HttpMethod.PATCH, "/api/v1/catalog/categories/*/visibility").authenticated()
                        .requestMatchers(HttpMethod.PUT, "/api/v1/catalog/categories/*/town-visibility").authenticated()
